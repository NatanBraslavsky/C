...
int main(void) {
  float valorTotalVenda[5], valorTotal = 0, valorTotalCamisaP = 0, mediaTotal = 0, abaixoDe = 0, valorTotalImpar = 0;
  ...
  int qtdCamisaTotal = 0, maiorQtdTipoVenda = 0;
  ...
  do {
    ...
    if (teste == 0) {
      printf("\nDigite um valor para saber a quantidade de vendas abaixo do "
             "preco digitado: R$");
      scanf("%f", &abaixoDe);
      for (int i = 0; i < 5; i++) {
        ...
        if (tipoVenda[i] % 2 != 0) {
          valorTotalImpar += valorTotalVenda[i];
        }
      }
      ...
      printf("Valor total de vendas com tipo de venda impar: R$%.2f\n",
             valorTotalImpar);
